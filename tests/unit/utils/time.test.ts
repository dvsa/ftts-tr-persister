...
import {
  convertTimespanToSeconds, executionTimeoutNearlyReached, Seconds, Timespan,
} from '../../../src/utils/time';
...
describe('Time utils', () => {
  ...
  describe('executionTimeoutNearlyReached', () => {
    ...
    test('returns true when elapsed time is within the given timeout buffer', () => {
      JEST_DATE_MOCK.advanceTo('2021-08-27T09:04:33');
